   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/швейцария/ароса.jpg" alt="ароса">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Ароса</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Arosa Lenzerheide</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="10000" onchange="calc()" id="count8">Стандарт - 10000₽</option>
                            <option value="18000" onchange="calc()" selected id="count9">Комфорт - 18000₽</option>
                            <option value="25000" onchange="calc()" id="count10">Premium - 25000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="22000" onchange="calc()" id="Air_class">Эконом-класс - 22000₽</option>
                            <option value="44000" onchange="calc()" id="Air_class">Premium-класс - 44000₽</option>
                        </select> 
                    </div>
