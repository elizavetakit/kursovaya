   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/израиль/эйн-бокек.jpg" alt="эйн-бокек">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Эйн-Бокек</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Oasis Dead Sea</p>
                        ...
                        <p class="text"> <b>Вид:</b> Семейный / Premium отдых</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="21000" onchange="calc()" id="Air_class">Эконом-класс - 21000₽</option>
