   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/швейцария/церматт.jpg" alt="церматт">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Церматт</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Vallées</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="5000" onchange="calc()" id="count8">Стандарт - 10000₽</option>
                            <option value="15000" onchange="calc()" selected id="count9">Комфорт - 18000₽</option>
                            <option value="23000" onchange="calc()" id="count10">Premium - 29000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 26000₽</option>
                            <option value="40000" onchange="calc()" id="Air_class">Premium-класс - 45000₽</option>
                        </select> 
                    </div>
