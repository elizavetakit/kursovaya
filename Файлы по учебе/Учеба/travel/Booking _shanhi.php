   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/китай/шанхай.jpg" alt="шанхай">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Шанхай</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Radisson Blu</p>
                        ...
                        <div class="text extensions text">
                            ...
                            <p class="extensions_tour">Фитнес</p>
                        </div>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="25000" onchange="calc()" id="Air_class">Эконом-класс - 25000₽</option>
