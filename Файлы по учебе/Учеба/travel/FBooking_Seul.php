   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/корея/сеул.jpg" alt="Сеул">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Сеул <img class="image-counry-nav" src="img/флаги/корея.png" alt="korea"></p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> LOTTE City</p>
                        ...
                        <p class="text"> <b>Вид:</b> Premium отдых</p>
                        ...
                        <div class="place-flex">
                            <h1 class="price-fire-tour">от 50000 ₽</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="5000" onchange="calc()" id="count8">Стандарт - 5000₽</option>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 20000₽</option>
