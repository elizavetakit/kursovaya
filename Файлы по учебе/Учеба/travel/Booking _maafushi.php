   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/мальдивы/маафуши.jpg" alt="маафуши">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Маафуши</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Kaani Palm Beach</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="37000" onchange="calc()" id="Air_class">Premium-класс - 37000₽</option>
                        </select> 
                    </div>
