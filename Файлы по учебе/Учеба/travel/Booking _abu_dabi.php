   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/ОАЭ/абу-даби.jpg" alt="абу-даби">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Абу-Даби</p>
                        <div class="hotel">
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="40000" onchange="calc()" id="Air_class">Premium-класс - 30000₽</option>
                        </select> 
                    </div>
