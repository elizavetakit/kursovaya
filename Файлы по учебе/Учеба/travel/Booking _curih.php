   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/швейцария/цюрих.jpg" alt="цюрих">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Цюрих</p>
                        <div class="hotel">
                        ...
                        <p class="text"> <b>Вид:</b> Экскурсионный / Premium отдых</p>
