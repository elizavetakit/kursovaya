   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/франция/солеил.jpg" alt="Ле-Корбье">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Ле-Корбье</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Central Hersonissos</p>
                        ...
                        <div class="text extensions text">
                            ...
                            <p class="extensions_tour">Инвентарь</p>
                        </div>
                            <h1 class="price">от 100000 ₽ </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 22000₽</option>
