   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/мексика/Тулум.jpg" alt="тулум">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Тулум</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Azulik</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="26000" onchange="calc()" id="Air_class">Эконом-класс - 26000₽</option>
                            <option value="36000" onchange="calc()" id="Air_class">Premium-класс - 36000₽</option>
                        </select> 
                    </div>
