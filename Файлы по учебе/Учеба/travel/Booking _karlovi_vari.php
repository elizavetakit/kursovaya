   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/чехия/карловы вары.jpg" alt="карловы вары">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Карловы Вары</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Pullman Paris</p>
                        ...
                        <p class="text"> <b>Вид:</b> Premium / семейный тур</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 15000₽</option>
                            <option value="40000" onchange="calc()" id="Air_class">Premium-класс - 35000₽</option>
                        </select> 
                    </div>
