   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/бразилия/рио-де-жанейро.jpg" alt="рио-де-жанейро">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Рио-де-Жанейро</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hotel Atlântico Travel</p>
                        ...
                        <p class="text"> <b>Вид:</b> Экономичный / экскурсионный отдых</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="19000" onchange="calc()" id="count10">Premium - 19000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
