   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/индонезия/убуд.jpg" alt="убуд">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Убуд</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Bliss Ubud Spa</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 90000₽</option>
                            <option value="40000" onchange="calc()" id="Air_class">Premium-класс - 14000₽</option>
                        </select> 
                    </div>
