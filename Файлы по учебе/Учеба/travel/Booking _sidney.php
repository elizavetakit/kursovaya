   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour" id="booking">
                    <img class="image_tour" src="img/туры/австралия/сидней.jpg" id="img">
                    <div class="text_tour text">
                        <p class="text" id="city"> <b>Город:</b> Сидней</p>
                        <div class="hotel">
                            <p class="text" id="hotel"> <b>Гостиница:</b> Four Seasons</p>
                            <div class="text" class="rating" id="rating">
                        ...
                        <p class="text" id="tipe_tour"> <b>Вид:</b> Premium / семейный отдых</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="15000" onchange="calc()" selected id="count9">Комфорт - 15000₽</option>
                            <option value="23000" onchange="calc()" id="count10">Premium - 23000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="40000" onchange="calc()" id="Air_class">Premium-класс - 40000₽</option>
                        </select> 
                    </div>
