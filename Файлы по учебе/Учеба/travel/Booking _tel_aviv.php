   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/израиль/тель-авив.jpg" alt="тель-авив">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Тель-Авив</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Royal Beach Hotel</p>
                        ...
                        <p class="text"> <b>Вид:</b> Pemium / Семейный отдых</p>
