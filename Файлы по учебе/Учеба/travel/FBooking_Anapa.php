   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                            <img class="image_tour" src="img/горящие туры/анапа.webp" alt="анапа">
                            <div class="text_tour text">
                                <p class="text"> <b>Город:</b> Анапа <img class="image-counry-nav" src="img/флаги/россия.png" alt="russia"></p>
                                <div class="hotel">
                                    <p class="text"> <b>Гостиница:</b> Prima</p>
                                ...
                                <p class="text"> <b>Дата:</b> 15.04.2021 - 19.04.2021</p>
                                <div class="text extensions text">
                                    <p class="extensions_tour">Wi-Fi</p>
                                </div>
                                <div class="place-flex">
                                    <h1 class="price-fire-tour">от 15000 ₽</h1>
                                </div>
                            </div>
                </div>
            ...
            <div class="booking-form">
                ...
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-04-15">
                    </div>
                    <div class="Data-e">
                        <p>Дата возвращения:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data2" value="2021-04-19">
                    </div>
                    <div class="Air">
                        <p>Перелет*</p>
                        <select name="Air" class="option-policy" id="Air">
                            <option value="7000" onchange="calc()" id="Air_class">Эконом-класс - 7000₽</option>
