   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                            <img class="image_tour" src="img/горящие туры/шерегеш-гринберг.jpg" alt="шерегеш-гринберг">
                            <div class="text_tour text">
                                <p class="text"> <b>Город:</b> Шерегеш <img class="image-counry-nav" src="img/флаги/россия.png" alt="russia"></p>
                                <div class="hotel">
                                    <p class="text"> <b>Гостиница:</b> Гринберг</p>
            ...
            <div class="booking-form">
                ...
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-04-28">
                    </div>
                    <div class="Data-e">
                        <p>Дата возвращения:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data2" value="2021-05-08">
                    </div>
                    <div class="Air">
                        <p>Перелет*</p>
                        <select name="Air" class="option-policy" id="Air">
                            <option value="8000" onchange="calc()" id="Air_class">Эконом-класс - 8000₽</option>
