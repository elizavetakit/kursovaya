   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/финляндия/леви.jpeg" alt="леви">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Леви <img class="image-counry-nav" src="img/флаги/финляндия.jpg" alt="Finliandia"></p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hotel Levi Panorama</p>
                        ...
                        <p class="text"> <b>Вид:</b> Горнолыжный / экстремальный тур</p>
                        <p class="text"> <b>Авиакомпания:</b> Аэрофлот</p>
                        <p class="text"> <b>Дата:</b> 05.05.2021 - 10.05.2021</p>
                        <div class="text extensions text">
                            <p class="extensions_tour">Wi-Fi</p>
                            <p class="extensions_tour">Питание</p>
                            <p class="extensions_tour">SPA</p>
                        </div>
                        <div class="place-flex">
                            <h1 class="price-fire-tour">от 48000 ₽</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="8000" onchange="calc()" id="count8">Стандарт - 8000₽</option>
                            <option value="8000" onchange="calc()" selected id="count9">Комфорт - 8000₽</option>
                            <option value="12000" onchange="calc()" id="count10">Premium - 12000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-05-05">
                    </div>
                    <div class="Data-e">
                        <p>Дата возвращения:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data2" value="2021-05-10">
                    </div>
                    <div class="Air">
                        <p>Перелет*</p>
                        <select name="Air" class="option-policy" id="Air">
                            <option value="15000" onchange="calc()" id="Air_class">Эконом-класс - 15000₽</option>
                            <option value="25000" onchange="calc()" id="Air_class">Premium-класс - 25000₽</option>
                        </select> 
                    </div>
