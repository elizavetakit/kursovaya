   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/исландия/акюрейри.jpg" alt="акюрейри">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Акюрейри</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hotel Kea Keahotels</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="20000" onchange="calc()" selected id="count9">Комфорт - 20000₽</option>
                            <option value="27000" onchange="calc()" id="count10">Premium - 27000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
