   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/корея/инчхон.jpg" alt="инчхон">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Инчхон</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Toyoko Inn</p>
                        ...
                        <button onclick="location.href='Booking.html'" class="booking">Забронировать</button>
                    </div>
                </div>
            </div>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="10000" onchange="calc()" selected id="count9">Комфорт - 10000₽</option>
