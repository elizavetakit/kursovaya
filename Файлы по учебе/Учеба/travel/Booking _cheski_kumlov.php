   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/чехия/Чески-Крумлов.jpg" alt="Чески-Крумлов">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Чески-Крумлов</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Gold</p>
                        ...
                        <p class="text"> <b>Вид:</b> Семейный тур</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="20000" onchange="calc()" id="Air_class">Эконом-класс - 18000₽</option>
