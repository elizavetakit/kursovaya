   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/мальдивы/мале.jpg" alt="мале">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Мале</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> JEN Maldives Malé</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="5000" onchange="calc()" id="count8">Стандарт - 8000₽</option>
