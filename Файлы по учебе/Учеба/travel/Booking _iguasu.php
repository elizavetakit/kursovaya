   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/бразилия/фос-ду-игуасу.jpg" alt="фос-ду-игуасу">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Фос-Ду-Игуасу</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> JL Hotel by Bourbon</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="19000" onchange="calc()" id="Air_class">Эконом-класс - 19000₽</option>
                            <option value="29000" onchange="calc()" id="Air_class">Premium-класс - 29000₽</option>
                        </select> 
                    </div>
