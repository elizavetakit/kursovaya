   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img\туры\россия/сочи.png" alt="байкал">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Сочи</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Гостевой дом Элион</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="9000" onchange="calc()" id="Air_class">Эконом-класс - 8000₽</option>
                            <option value="17000" onchange="calc()" id="Air_class">Premium-класс - 17000₽</option>
                        </select> 
                    </div>
