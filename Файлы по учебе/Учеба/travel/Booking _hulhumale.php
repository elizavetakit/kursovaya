   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/мальдивы/хулхумале.jpg" alt="хулхумале">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Xулхумале</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Samann Host</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="15000" onchange="calc()" id="count10">Premium - 14000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
