   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/австралия/брисбен.jpg" alt="брисбен">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Брисбен</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> W Brisbane</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="7000" onchange="calc()" id="count8">Стандарт - 5000₽</option>
                            <option value="17000" onchange="calc()" selected id="count9">Комфорт - 17000₽</option>
                            <option value="28000" onchange="calc()" id="count10">Premium - 28000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
