   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/ирландия/килларни.jpg" alt="колларни">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Колларни</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Salthill Hotel</p>
                        ...
                        <p class="text"> <b>Вид:</b> Premium / экскурсионный отдых</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="14000" onchange="calc()" id="Air_class">Эконом-класс - 14000₽</option>
