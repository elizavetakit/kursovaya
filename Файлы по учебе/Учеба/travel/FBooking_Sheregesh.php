   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
            <div class="card_tour">
                <img class="image_tour" src="img/горящие туры/шерегеш.jpg" alt="шерегеш">
                <div class="text_tour text">
                    <p class="text"> <b>Курорт:</b> Шерегеш <img class="image-counry-nav" src="img/флаги/россия.png" alt="russia"></p>
                    <div class="hotel">
                        <p class="text"> <b>Гостиница:</b> Bella Vista</p>
            ...
            <div class="booking-form">
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="2000" onchange="calc()" id="count8">Стандарт - 2000₽</option>
                ...
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-04-20">
                    </div>
                    <div class="Data-e">
                        <p>Дата возвращения:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data2" value="2021-04-30">
                    </div>
                    <div class="Air">
                        <p>Перелет*</p>
                        <select name="Air" class="option-policy" id="Air">
                            <option value="10000" onchange="calc()" id="Air_class">Эконом-класс - 10000₽</option>
                            <option value="15000" onchange="calc()" id="Air_class">Premium-класс - 15000₽</option>
                        </select> 
                    </div>
