                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="5000" onchange="calc()" id="count8">Стандарт - 2000₽</option>
                            <option value="8000" onchange="calc()" selected id="count9">Комфорт - 8000₽</option>
                            <option value="16000" onchange="calc()" id="count10">Premium - 16000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="17000" onchange="calc()" id="Air_class">Эконом-класс - 17000₽</option>
                            <option value="27000" onchange="calc()" id="Air_class">Premium-класс - 27000₽</option>
                        </select> 
                    </div>
