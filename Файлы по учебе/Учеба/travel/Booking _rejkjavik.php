   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/исландия/рейкьявик.jpg" alt="рейкьявик">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Рейкьявик</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Midgardur by Center</p>
                        ...
                        <p class="text"> <b>Вид:</b> Семейный / экскурсионный тур</p>
