   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/корея/чеджу.jpg" alt="чеджу">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Чеджу</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Grabel Jeju</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="18000" onchange="calc()" id="Air_class">Эконом-класс - 18000₽</option>
                            <option value="35000" onchange="calc()" id="Air_class">Premium-класс - 35000₽</option>
                        </select> 
                    </div>
