   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/черногория/будва.jpg" alt="будва">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Будва</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Splendid Confer</p>
                        ...
                        <p class="text"> <b>Вид:</b> Pemium отдых</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="38000" onchange="calc()" id="Air_class">Premium-класс - 38000₽</option>
                        </select> 
                    </div>
