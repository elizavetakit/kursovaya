   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/исландия/митван.jpg" alt="митван">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Митван</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hótel Laxá</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="26000" onchange="calc()" id="Air_class">Premium-класс - 26000₽</option>
                        </select> 
                    </div>
