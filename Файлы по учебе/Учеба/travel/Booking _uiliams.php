   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/сша/уильямс.jpg" alt="Уильямс">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Уильямс</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> La Quinta Wyndham</p>
                        ...
                        <p class="text"> <b>Вид:</b> Экскурсионный / экстремальный тур</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="27000" onchange="calc()" id="Air_class">Эконом-класс - 27000₽</option>
