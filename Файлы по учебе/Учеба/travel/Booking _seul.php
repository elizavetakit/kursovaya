            ...
            <div class="booking-tour">
                ...
                <div class="card_tour">
                    ...
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Сеул</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> LOTTE City Hotel</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="9000" onchange="calc()" id="count8">Стандарт - 9000₽</option>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="24000" onchange="calc()" id="Air_class">Эконом-класс - 24000₽</option>
