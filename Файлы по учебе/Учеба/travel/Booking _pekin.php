   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/китай/пекин.jpg" alt="пекин">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Пекин</p>
                        <div class="hotel">
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="33000" onchange="calc()" id="Air_class">Premium-класс - 33000₽</option>
                        </select> 
                    </div>
