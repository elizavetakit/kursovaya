   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/великобритания/эдинбург.jpg" alt="эдинбург">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Эдинбург <img class="image-counry-nav" src="img/флаги/великобритания.png" alt="UK"></p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> ibis budget Hotel</p>
                        ...
                        <p class="text"> <b>Вид:</b> Экскурсионный / Семейный отдых</p>
                        <p class="text"> <b>Авиакомпания:</b> Аэрофлот</p>
                        <p class="text"> <b>Дата:</b> 26.04.2021 - 01.05.2021</p>
                        ...
                        <div class="place-flex">
                            <h1 class="price-fire-tour">от 38000 ₽</h1>
                        </div>
                    </div>
            </div>
            <div class="booking-form">
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            <option value="3000" onchange="calc()" id="count8">Стандарт - 3000₽</option>
                ...
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-04-26">
                    </div>
                    <div class="Data-e">
                        <p>Дата возвращения:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data2" value="2021-05-01">
                    </div>
                    <div class="Air">
                        <p>Перелет*</p>
