   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/черногория/херцег-нови.jpg" alt="херцег-нови">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Херцег-Нови</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hotel Azzurro</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="6000" onchange="calc()" selected id="count9">Комфорт - 6000₽</option>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="24000" onchange="calc()" id="Air_class">Premium-класс - 24000₽</option>
                        </select> 
                    </div>
