   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/турция/аланья.jpg" alt="аланья">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Аланья</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Riviera Hotel</p>
                        ...
                        <p class="text"> <b>Вид:</b> Экономичный / семейный отдых</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="12000" onchange="calc()" selected id="count9">Комфорт - 12000₽</option>
