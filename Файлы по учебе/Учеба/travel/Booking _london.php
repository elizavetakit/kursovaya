   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/великобритания/лондон.jpg" alt="лондон">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Лондон</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Park Plaza</p>
                ...
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            <option value="23000" onchange="calc()" id="Air_class">Эконом-класс - 23000₽</option>
                            <option value="39000" onchange="calc()" id="Air_class">Premium-класс - 39000₽</option>
                        </select> 
                    </div>
