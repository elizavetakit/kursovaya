   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/греция/салоники.jpg" alt="салоники">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Салоники</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Palace Saloniki</p>
                        ...
                        <p class="text"> <b>Вид:</b> Premium / семейный отдых</p>
