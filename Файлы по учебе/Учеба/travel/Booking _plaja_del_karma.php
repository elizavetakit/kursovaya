   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/мексика/Плая-дель-Кармен.jpeg" alt="Плая-дель-Кармен">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Плая-дель-Кармен</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Hotel 52 Playa</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="17000" onchange="calc()" id="count10">Premium - 17000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
