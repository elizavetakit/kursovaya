   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
            <div class="card_tour">
                        <img class="image_tour" src="img/туры/сша/сан-франциско.jpg" alt="сан-франциско">
                        <div class="text_tour text">
                            <p class="text"> <b>Город:</b> Сан-Франциско <img class="image-counry-nav" src="img/флаги/сша.png" alt="USA"></p>
                            <div class="hotel">
                                <p class="text"> <b>Гостиница:</b> Coventry Motor Inn</p>
                            ...
                            <p class="text"> <b>Вид:</b> Экономичный отдых</p>
                            <p class="text"> <b>Авиакомпания:</b> Аэрофлот</p>
                            <p class="text"> <b>Дата:</b> 25.04.2021 - 30.04.2021</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="9000" onchange="calc()" selected id="count9">Комфорт - 9000₽</option>
                            <option value="18000" onchange="calc()" id="count10">Premium - 18000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Data">
                        <p>Дата вылета:*</p>
                        <input type="date" class="option-policy" onchange="calc()" id="Data" value="2021-04-25">
                    </div>
                    <div class="Data-e">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="30000" onchange="calc()" id="Air_class">Premium-класс - 30000₽</option>
                        </select> 
                    </div>
