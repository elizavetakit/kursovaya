   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img\туры\россия/алтай.jpg" alt="алтай">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Горно-Алтайск</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Гостиный Двор</p>
                        ...
                        <p class="text"> <b>Вид:</b> Экстремальный тур</p>
                        ...
                        <div class="text extensions text">
                            ...
                            <p class="extensions_tour">Экстрим. развлечения</p>
                        </div>
                            <h1 class="price">от 50000 ₽ </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="form1">
                    <div class="policy">
                        ...
                        <select name="policy" class="option-policy" id="policy"> 
                            ...
                            <option value="150" selected onchange="calc()" id="count2">Страховка медецинска - 150₽</option>
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="7000" onchange="calc()" selected id="count9">Комфорт - 7000₽</option>
                            <option value="15000" onchange="calc()" id="count10">Premium - 15000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="20000" onchange="calc()" id="Air_class">Premium-класс - 20000₽</option>
                        </select> 
                    </div>
