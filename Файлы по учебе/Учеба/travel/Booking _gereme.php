   ...
   <main class="main_page">
        <div class="container">
            ...
            <div class="booking-tour">
                <h3>Ваш тур</h3>
                <div class="card_tour">
                    <img class="image_tour" src="img/туры/турция/гёреме.jpg" alt="гёреме">
                    <div class="text_tour text">
                        <p class="text"> <b>Город:</b> Гёреме</p>
                        <div class="hotel">
                            <p class="text"> <b>Гостиница:</b> Elite Cave Suites</p>
                ...
                <div class="form1">
                    ...
                    <div class="Number-room">
                        ...
                        <select name="Number-room" class="option-policy" id="Number_room">
                            ...
                            <option value="14000" onchange="calc()" id="count10">Premium - 14000₽</option>
                        </select> 
                    </div>
                </div>
                <div class="form2">
                    ...
                    <div class="Air">
                        ...
                        <select name="Air" class="option-policy" id="Air">
                            ...
                            <option value="23000" onchange="calc()" id="Air_class">Premium-класс - 23000₽</option>
                        </select> 
                    </div>
